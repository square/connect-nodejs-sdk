...
exports.constructFromObject = function(data, obj) {
  if (data) {
    obj = obj || new exports();
      ...
      if (data.hasOwnProperty('item_price_money')) {
      obj['item_price_money'] = Money.constructFromObject(data['item_price_money']);
    }
      ...
      obj['stackable'] = ApiClient.convertToType(data['stackable'], 'String');
    }
 ...
 * @member {module:model/Money} item_price_money
 */
exports.prototype['item_price_money'] = undefined;
/**
